...
export const MainLayout: React.FC = () => {
  ...
  return (
    <Layout className={`min-h-screen transition-colors duration-300`}>
      ...
      >
        <Header />
        <Content className={`m-4 md:m-6 p-4 md:p-6 rounded-lg shadow-sm overflow-initial min-h-[280px] transition-colors duration-300 ${isDarkMode ? 'bg-[#1f1f1f]' : 'bg-white'}`}>
          <ErrorBoundary>
